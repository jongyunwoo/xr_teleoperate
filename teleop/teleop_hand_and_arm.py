...
if __name__ == '__main__':
    ...
    parser.add_argument('--carpet_sensitivity', type=int, default=250,
                        help='Set carpet tactile sensor sensitivity (default: 1.0)')
    parser.add_argument('--carpet_headless', action='store_true',
                        help='Enable headless mode for carpet tactile sensor data collection')
    parser.add_argument('--carpet_tty', type=str, default='/dev/tty.usbserial-02857AC6',
                        help='Set the TTY port for carpet tactile sensors (default: /dev/tty.usbserial-02857AC6)')
    parser.add_argument()
